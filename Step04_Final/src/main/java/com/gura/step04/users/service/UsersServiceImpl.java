...
public class UsersServiceImpl implements UsersService{
	...
	public void loginProcess(UsersDto dto, HttpSession session) {
		...
		if(result != null) {//만일 존재하는 아이디 라면
			...
			//Bcrypt 클래스의 static 메소드 checkpw 를 이용해서 일치 여부를 얻어낸다.
			isValid=BCrypt.checkpw(inputPwd, encodedPwd); //스태틱 메소드니까 그냥 점 찍어서 사용 가능(뉴 필요 없음)
			// true 혹은  false 리턴하면
		}
